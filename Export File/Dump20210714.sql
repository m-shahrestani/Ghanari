...
INSERT INTO `new_log` VALUES ('ab','2021-07-13'),('b','2021-07-13'),('c','2021-07-13'),('e','2021-07-13'),('gak','2021-07-13'),('q','2021-07-13'),('r','2021-07-14'),('w','2021-07-13');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `check_user`(in given_user_name varchar(20), out taken_password varchar(128))
begin
	select user.password into taken_password
	from user
...
-- Dump completed on 2021-07-14 10:11:18
